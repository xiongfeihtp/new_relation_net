...
flags.DEFINE_string("result_path",'./ensemble_item','ensemble result save path')
...
flags.DEFINE_integer("seed", 9, "random seed")
...
flags.DEFINE_float("init_lr", 3.9063e-3, "Initial learning rate for Adadelta")
...
flags.DEFINE_integer("max_to_keep",20,"max numbers of saved model")
